...
class files:
    ...
    def view_files(self):
        self.path=input("Please enter path where files to be displayed are present e.g,<c:\users\murali\>:")
    ...
    def user_interests(self):
        ...
        print("visit https://myaccount.google.com/security for setting this up ")
        print("########################################################################################################")
    ...
    def execution(self,Choice):
        if Choice==1:
            ...
            if t=={} :   
                print("Email has been sent successfully with attachments!!")
            else:
